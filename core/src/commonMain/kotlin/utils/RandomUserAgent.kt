package io.github.mrnemo.reversokt.utils

import kotlin.math.floor
import kotlin.random.Random

private val freqMap = hashMapOf(
    "Internet Explorer" to 11.8,
    "Firefox" to 28.2,
    "Chrome" to 52.9,
    "Safari" to 3.9,
    "Opera" to 1.8
...
fun randomUserAgent(): String {
    ...
    return userAgents!![floor(Random.nextDouble() * userAgents.size).toInt()]
}